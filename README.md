...
* [Константин Фадеев](https://github.com/Stern-Ritter).
...
##
Phoenix
* Заполнение и отображение поля «О себе».
* Обновление страницы с постами.
* Подписка на теги и отписка от тегов.
* Отображение ленты подписок пользователя.
* Популярные статьи и теги.
* Разметка публикаций с помощью Markdown.
* Регистрация по приглашениям.
* Премодерация публикаций и модерация комментариев.
* Панель администратора.
* Поле подтверждения пароля.
* Реализована загрузка изображений на сервер путем их загрузки, а не прикладывания url.
* Реализовано несколько визуальных улучшений по обновлениям в макетах.
